...
@implementation UIImage (Impress)
...
{
    CGSize sorceSize = self.size;
    UIGraphicsBeginImageContext(CGSizeMake(sorceSize.width * factor, sorceSize.height * factor));
    [self drawInRect:CGRectMake(0,0,sorceSize.width * factor, sorceSize.height * factor)];
