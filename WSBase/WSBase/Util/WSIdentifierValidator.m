...
@implementation WSIdentifierValidator
...
+ (BOOL) isValidPhone:(NSString*)value {
    ...
    if (![WSIdentifierValidator isValidNumber:value])
    {
        return FALSE;
    }
...
+ (BOOL) isValidCaptcha:(NSString *)value
{
...
+ (BOOL) isValidPwd:(NSString *)value
{
...
+ (BOOL) isValid:(IdentifierType) type value:(NSString*) value
{
    ...
    switch (type)
    {
        case IdentifierTypeZipCode:
            result = [WSIdentifierValidator isValidZipcode:value];
            break;
        case IdentifierTypeEmail:
            //            result = [IdentifierValidator isValidEmail:value];
            result = [WSIdentifierValidator isValidEmail:value];
            break;
        case IdentifierTypePhone:
            result = [WSIdentifierValidator isValidPhone:value];
            break;
        case IdentifierTypeUnicomPhone:
            result = [WSIdentifierValidator isChinaUnicomPhoneNumber:value];
            break;
        ...
        case IdentifierTypeString:
            result = [WSIdentifierValidator isValidString:value];
            break;
        case IdentifierTypeIdentifier:
            result = [WSIdentifierValidator isValidIdentifier:value];
            break;
        case IdentifierTypePassort:
            result = [WSIdentifierValidator isValidPassport:value];
            break;
        case IdentifierTypeCreditNumber:
           // result = [WSIdentifierValidator isValidCreditNumber:value];
            break;
        case IdentifierTypeBirthday:
            result = [WSIdentifierValidator isValidBirthday:value];
            break;
        default:
            break;
    }
